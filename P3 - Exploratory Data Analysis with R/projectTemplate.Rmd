...
All variables have gaussian distribution, except for residual sugar and alcohol. 
...
This is due to the process of fermentation that transforms sugar (dense) to alcohol (less dense). This is confirmed by the negative correlation between residual sugar and alcohol (-0.435).
